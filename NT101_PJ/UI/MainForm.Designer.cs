namespace NT101_PJ
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.Location = new Point(368, 176);
            label3.Name = "label3";
            label3.Size = new Size(197, 46);
            label3.TabIndex = 2;
            label3.Text = "NT101.P11";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Segoe UI", 20.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label4.Location = new Point(253, 237);
            label4.Name = "label4";
            label4.Size = new Size(462, 46);
            label4.TabIndex = 3;
            ...
            label5.Location = new Point(306, 319);
            label5.Name = "label5";
            label5.Size = new Size(351, 37);
            label5.TabIndex = 4;
            label5.Text = "Lê Thị Thùy Trang 22521511";
            ...
            btPlayFair.Location = new Point(518, 471);
            btPlayFair.Margin = new Padding(3, 4, 3, 4);
            btPlayFair.Name = "btPlayFair";
            btPlayFair.Size = new Size(128, 91);
